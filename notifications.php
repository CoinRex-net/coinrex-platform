        ...
        <section class="notif-shell">
            <div class="notif-head">
                ...
                <div class="notif-actions">
                    ...
                    <a href="<?php echo htmlspecialchars(BASE_URL . '/dashboard.php', ENT_QUOTES, 'UTF-8'); ?>" class="notif-action-btn"><i class="fas fa-arrow-left"></i><span>Back to RexHub</span></a>
                </div>
            </div>
                ...
                <div class="notif-list" id="notifList">
                    <?php foreach ($items as $n): ?>
                        <?php
                            ...
                            $notificationHref = trim((string) ($n['action_url'] ?? '')) !== '' ? (string) $n['action_url'] : (string) (BASE_URL . '/notifications.php?status=all');
