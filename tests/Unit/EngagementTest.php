...
final class EngagementTest extends TestCase {
 ...
 public function testTelegramUrlAllowsUnderscoreAndNormalizesPastedFormatting():void{$url='https://t.me/CoinRex_Officials';$this->assertSame($url,engagementNormalizeUrl("\u{FEFF}\"https\\:\/\/t.me\/CoinRex\\_Officials\""));$this->assertTrue(engagementValidHttpsUrl($url));$this->assertTrue(engagementValidProfileUrl('telegram',$url));$this->assertTrue(engagementValidProfileUrl('telegram',"\u{200B}".$url));}
