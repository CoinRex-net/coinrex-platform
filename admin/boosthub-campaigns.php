...
.campaign-status.is-active{background:rgba(34,197,94,.14);color:#86efac}.campaign-status.is-paused{background:rgba(245,158,11,.14);color:#fcd34d}.campaign-status.is-completed{background:rgba(96,165,250,.14);color:#93c5fd}.campaign-popup-state{display:inline-flex;align-items:center;gap:6px;padding:5px 9px;border-radius:999px;font-size:11px;font-weight:700;background:rgba(148,163,184,.12);color:#cbd5e1}.campaign-popup-state.is-active{background:rgba(34,197,94,.14);color:#86efac}
...
.campaign-cover-group{grid-column:1/-1}.campaign-popup-group{grid-column:1/-1}.campaign-toggle-field{flex-direction:row!important;align-items:flex-start;gap:12px!important;padding:13px 14px;border:1px solid rgba(59,130,246,.18);border-radius:12px;background:rgba(59,130,246,.08)}.campaign-toggle-field input{width:auto!important;margin-top:3px}.campaign-toggle-field strong{display:block;color:#f8fafc;font-size:13px}.campaign-toggle-field span{display:block;color:#94a3b8;font-size:11px;line-height:1.45;margin-top:3px}.campaign-cover-preview{position:relative;width:100%;aspect-ratio:3/1;max-height:190px;display:grid;place-items:center;border:1px dashed rgba(148,163,184,.28);border-radius:14px;background:linear-gradient(135deg,#0b1220,#172554);color:#64748b;overflow:hidden}.campaign-cover-preview img{width:100%;height:100%;object-fit:cover}.campaign-popup-preview{position:relative;width:100%;aspect-ratio:16/9;max-height:260px;display:grid;place-items:center;border:1px dashed rgba(148,163,184,.28);border-radius:14px;background:linear-gradient(135deg,#111827,#172554);color:#64748b;overflow:hidden}.campaign-popup-preview img{width:100%;height:100%;object-fit:cover}.campaign-cover-controls{display:grid;grid-template-columns:1fr auto 1fr;gap:10px;align-items:center;margin-top:9px}.campaign-cover-controls input[type=file]{padding:8px;font-size:11px}
