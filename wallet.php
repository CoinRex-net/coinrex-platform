 ...
 * Public APK download page with Play Store-style metrics
...
$page_title = 'RexLink — Extension Free Web3 Access';
$meta_description = 'Download RexLink — the secure, non-custodial mobile wallet for CoinRex. Approve transactions, link your wallet, and manage rewards from your phone.';
        ...
        <div class="wallet-container">
            <div class="wallet-download-card wallet-reveal">
                <div class="wallet-download-app-icon">
                    <img src="<?php echo ASSETS_URL; ?>/images/shield-logo.png" alt="RexLink" onerror="this.onerror=null; this.parentElement.innerHTML='<span style=\'font-size:2.5rem;\'>🦁</span>';">
                </div>
