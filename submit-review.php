...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_review'])) {
    ...
    if (!validateAppCsrfToken((string) ($_POST['csrf_token'] ?? ''))) {
        ...
        if (empty($tx_hash)) $errors[] = 'Transaction hash is required';
            ...
            try {
                ...
                if ($result) {
                    ...
                    if ($auto_approve && $new_review_id > 0) {
                        ...
                        $review_updates = ["status = 'approved'", "proof_status = 'pending'", "updated_at = NOW()"];
                        $review_params = [];
...
<main class="submit-review-main">
    <div class="submit-container submit-container-upgraded">
            ...
            <div class="hero-grid">
                <div class="hero-copy">
                    ...
                    <div class="hero-points">
                        ...
                        <div class="hero-point"><i class="fas fa-camera"></i><span>Proof-first verification</span></div>
        ...
        <?php if(!$project && $project_id > 0): ?>
            <div class="error-message">Project not found. Please go back to <a href="<?php echo BASE_URL; ?>/projects.php">Projects Page</a>.</div>
        <?php elseif(!$project): ?>
            <div class="error-message">Please select a project from the <a href="<?php echo BASE_URL; ?>/projects.php">Projects Page</a> first.</div>
            ...
            <div class="review-status-card">
                ...
                <div class="review-status-copy">
                    ...
                    <div class="review-status-actions">
                        <a href="<?php echo BASE_URL; ?>/my-reviews.php" class="btn-submit">View My Reviews</a>
                        <a href="<?php echo BASE_URL; ?>/project-detail.php?id=<?php echo (int) $project['id']; ?>" class="btn-cancel">Back to Project</a>
                    </div>
                </div>
            </div>
        <?php else: ?>
            ...
            <div class="review-trust-grid">
                <article class="review-trust-item">
                    ...
                    <div class="review-trust-copy">
                        <strong>Show only useful proof</strong>
                        <p>Add only the proof that clearly shows your interaction.</p>
                    </div>
                </article>
                <article class="review-trust-item">
                    <div class="review-trust-icon">
                ...
                <article class="review-trust-item">
                    ...
                    <div class="review-trust-copy">
                        <strong>Exchange wallet? Be clearer</strong>
                        <p>Exchange-wallet screenshots should be extra clear.</p>
                    </div>
                </article>
                <article class="review-trust-item">
                    <div class="review-trust-icon">
        ...
        <form method="POST" enctype="multipart/form-data" id="reviewForm" novalidate>
            ...
            <div class="wizard-progress wizard-progress-upgraded">
                ...
                <div class="wizard-step-nav active" data-nav-step="1"><span>1</span><strong>Show proof</strong><small>Wallet, TX & screenshot</small></div>
                ...
                <section class="wizard-step active" data-step="1">
                    <div class="step-intro">
                        <div>
                            ...
                            <h3><i class="fas fa-shield-alt"></i> Show your proof</h3>
                            <p class="section-note">Add the proof that best supports your review.</p>
                        </div>
                        <aside class="step-tip-card">
                            <strong><i class="fas fa-lightbulb"></i> Beginner tip</strong>
                            <p>Use the clearest screenshot you have.</p>
                        </aside>
                    </div>

                    <div class="wallet-explain">
                        <div class="section-mini-head">
                            <h4><i class="fas fa-wallet"></i> Pick your wallet type</h4>
                            <span class="optional-chip">Required</span>
                        </div>
                        <p>Choose the matching wallet type.</p>
                        <div class="wallet-grid">
                            <label class="wallet-option">
                                <input type="radio" name="wallet_type" value="non_custodial" <?php echo normalizeWalletType($form['wallet_type']) === 'non_custodial' ? 'checked' : ''; ?>>
                                <span><b>Non-custodial</b><small>MetaMask, Trust Wallet, Phantom</small></span>
                            </label>
                            <label class="wallet-option">
                                <input type="radio" name="wallet_type" value="custodial" <?php echo normalizeWalletType($form['wallet_type']) === 'custodial' ? 'checked' : ''; ?>>
                                <span><b>Custodial</b><small>Binance, Coinbase, OKX exchange wallet</small></span>
                            </label>
                        </div>
                    </div>

                    <div class="proof-grid">
                        <div class="form-group"><label>Transaction Hash (TX Hash) <span class="required-asterisk">*</span><span class="field-note field-note-block">Purpose: Used to match on-chain activity when possible</span></label><input type="text" name="tx_hash" id="tx_hash" value="<?php echo esc($form['tx_hash']); ?>" placeholder="0x... (from explorer or transfer record)"></div>
                        <div class="form-group"><label>Wallet Address <span class="required-asterisk">*</span><span class="field-note field-note-block">Purpose: Reviewed as proof, never ask for private keys</span></label><input type="text" name="wallet_address" id="wallet_address" value="<?php echo esc($form['wallet_address']); ?>" placeholder="0x... or exchange-linked wallet address"></div>
                        ...
                        <div class="form-group full-width">
                            <label>Screenshot Proof <span class="required-asterisk">*</span><span class="field-note field-note-block">Purpose: Show transaction, holding, or usage clearly</span></label>
                            <div class="file-upload-area" id="fileUploadArea"><i class="fas fa-cloud-upload-alt"></i><p>Upload screenshot</p><small>Hide sensitive info if not needed.</small><input type="file" name="screenshot" accept="image/*" hidden id="screenshotInput"></div>
                ...
                <section class="wizard-step" data-step="4">
                    ...
                    <div class="consent-panel">
                        ...
                        <div class="final-review-card">
                            ...
                            <div class="final-review-item"><span>Proof Required</span><strong>Wallet + TX Hash + Screenshot</strong></div>
    ...
    <div class="terms-modal-content">
        ...
        <div class="terms-modal-body">
            <div class="terms-list">
                ...
                <div class="term-item"><i class="fas fa-check-circle"></i><div><strong>Proof Required</strong><p>Provide real TX hash, wallet address, and screenshot that match your claimed experience.</p></div></div>
                ...
                <div class="term-item"><i class="fas fa-check-circle"></i><div><strong>Wallet Type Impact</strong><p>Non-custodial proof is easier to verify. Custodial proof relies more on screenshots and uses a reduced multiplier.</p></div></div>
            </div>
...
(function() {
    ...
    function validateStep(step) {
        if (step === 1) {
            ...
            if (!tx || !wa || ha <= 0 || hd <= 0 || !file) {
                showToast('Step 1 incomplete: add proof details and screenshot.', 'error');
                return false;
            }
        }
