...
<main class="terms-main">
    <div class="terms-container">
        ...
        <!-- Hero Section -->
        <div class="terms-hero animate-on-scroll">
        ...
        <div class="terms-content">
            ...
            <div class="terms-section animate-on-scroll">
                ...
                <div class="section-body">
                    ...
                    <ul class="allowed-list">
                        <li><i class="fas fa-check-circle allowed"></i> Complete tasks</li>
                        <li><i class="fas fa-check-circle allowed"></i> Submit reviews</li>
                        <li><i class="fas fa-check-circle allowed"></i> Participate in voting</li>
                        <li><i class="fas fa-check-circle allowed"></i> Earn internal rewards ($REX)</li>
                    </ul>
                    <p>You agree to use the platform only for lawful purposes and not engage in:</p>
                    <ul class="restricted-list">
                        <li><i class="fas fa-ban restricted"></i> Fraudulent activities</li>
                        <li><i class="fas fa-ban restricted"></i> Spam or bot usage</li>
                        <li><i class="fas fa-ban restricted"></i> Fake reviews or misleading content</li>
                        <li><i class="fas fa-ban restricted"></i> Abuse of referral systems</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="terms-section animate-on-scroll">
                ...
                <div class="section-body">
                    ...
                    <div class="info-box">
                        <i class="fas fa-info-circle"></i>
                        <div>
                            <p>$REX is a virtual reward and has no guaranteed to real monetary value</p>
                            <p>Rewards are subject to change at any time</p>
                            <p>Abuse or manipulation of the reward system may result in account suspension</p>
                        </div>
                    </div>
                    <p>Future tokenization of $REX is subject to platform development.</p>
            ...
            <div class="terms-section animate-on-scroll">
                ...
                <div class="section-body">
                    <p>We may suspend or terminate your account if you:</p>
                    <ul>
                        <li><i class="fas fa-ban restricted"></i> Violate these terms</li>
                        <li><i class="fas fa-ban restricted"></i> Engage in suspicious or abusive behavior</li>
                        <li><i class="fas fa-ban restricted"></i> Attempt to exploit the platform</li>
                    </ul>
                    <p>Decisions regarding account suspension are final.</p>
                </div>
            </div>
                ...
                <div class="section-body">
                    ...
                    <div class="warning-box">
                        ...
                        <div>
                            <p>We are not responsible for:</p>
                            <ul>
                                <li>Loss of earnings or rewards</li>
        ...
        <div class="terms-footer animate-on-scroll">
            <div class="acceptance-box">
                ...
                <p>By using CoinRex, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</p>
            </div>
        </div>
